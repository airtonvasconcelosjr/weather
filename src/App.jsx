...
function App() {
  ...
  return (
    <div className="flex flex-col w-full mt-[100px] h-screen bg sm:justify-center items-center">
      <form onSubmit={handleSubmit} className="fixed bottom-0 w-full flex p-4 sm:relative justify-center">
        <input
          type="text"
          placeholder="Digite a Cidade"
          className="p-3 rounded-lg outline-none w-full sm:max-w-[250px] flex-1"
          value={city}
